...
namespace SmartH2RCore.Core.Migrations
{
    ...
    [Migration("20210211144455_UpdateStaffType")]
    partial class UpdateStaffType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartH2RCore.Models.Common.BranchStaffType", b =>
                {
                    b.Property<int>("BranchId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BranchId", "StaffTypeId");

                    b.HasIndex("StaffTypeId");

                    b.ToTable("BranchStaffType", "Company");
                });
            ...
            modelBuilder.Entity("SmartH2RCore.Models.Common.StaffType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartH2RCore.Models.Common.BranchStaffType", b =>
                {
                    b.HasOne("SmartH2RCore.Models.Common.Branch", "Branch")
                        .WithMany("BranchStaffType")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartH2RCore.Models.Common.StaffType", "StaffType")
                        .WithMany()
